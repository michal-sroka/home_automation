...
MIN_WAIT_TIME_S = 5
SNAPSHOT_FILE_NAME=sys.argv[1] if len(sys.argv) >= 2 else "snapshot.json"
AZURE_CONFIG_FILE_NAME=sys.argv[2] if len(sys.argv) >= 3 else 'azure_config.json'
...
def  read_azure_storage_account_info(filename = 'azure_config.json'):
